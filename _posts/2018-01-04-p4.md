---
layout:     post
title: A super-fast & compact introduction to the P4 programming language 
...
If everything was done as it was supposed to, you will see the message `Anshuman is awesome` on the terminal in which you executed `receive.py`! If you had done this efore solving `scrambler.p4` the message would never have been delivered. This means we have finally achieved what we set out to do!
